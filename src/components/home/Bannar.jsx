        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-6 text-gray-600 text-base sm:text-lg">
              Discover opportunities to grow through quality education, build a
              successful career, and participate in exciting competitions. Our
              platform connects students with valuable learning resources,
